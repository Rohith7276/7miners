...
const Navbar = () => {
  ...
  return (
    <nav className='flex z-[100]     w-[99vw]  justify-center items-center bg-white py-3 border-b-2 border-gray-200 px-2 md:px-0  fixed top-0 left-0 z-50 transition-transform duration-300'>
      <div className=' m-auto w-full !w-[70%] flex justify-between  '>
