...
const Navbar = () => {
  ...
  return (
       <nav className='flex z-[100]  lg:px-[279px]
    margin: 0; w-screen  justify-between items-center bg-white py-3 border-b-2 border-gray-200 px-2 md:px-12   fixed top-0 left-0 z-50 transition-transform duration-300'>
