...
const Cart = () => {
  ...
  const { cart, getData, addToCart, modifyCart, removeToCart, cartQuantity, item } = useCartStore()
    ...
    <div className="flex flex-col items-start mt-24 min-h-[68vh] justify-center m-auto w-[90vw] md:w-[70rem] mb-11 bg-white text-gray-500">
      <div className="text-start w-full">
        ...
        <div className="container mx-auto py-4">
          ...
          {cartItems.map((item) => {
            return <>
              {item.quantity && <div className="grid grid-cols-3 items-center mb-4">
                <div className="grid grid-rows-2 items-center    md:grid-cols-2 md:grid-rows-1   space-x-4 mb-4 md:mb-0">
                  <img
                ...
                <div className="flex justify-center items-center text-black">
                  <div className="flex items-center border border-gray-500 w-fit py-1 md:py-2 rounded-sm">
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        if (v === "" || Number(v) === 0) {
                          v = "1"; // enforce minimum 1
                        }

                        modifyCart(item.id, Number(v));
                      }}
                    />
                  ...
                  <Trash
                    ...
                    onClick={() => {
                      removeToCart(item.id, item.quantity)
                    }}
                  />
                </div>
