...
const Bitaxe = () => {
  ...
  <div className='flex m-8 mt-32 flex-col items-center lg:flex-row items-top lg:mx-28'>

            <div className='postcard overflow-hidden    border w-full ml-[9vw] md:ml-[5vw] mt-4 md:w-[50vw]  appear opacity-0 shadow-sm border-gray-100'>
