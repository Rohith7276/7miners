...
const Bitaxe = () => {
    ...
    return (
        <div className='my-7'>
            <div className='cartAppear opacity-0 top-[1.5rem]  right-24 shadow-sm w-[25vw] border justify-center items-center absolute bg-white z-50 p-5'>
            ...
            <div className='flex m-8 mt-24 flex-col  lg:flex-row items-top lg:mx-28'>                               <div className='postcard overflow-hidden border w-full ml-5 lg:ml-0 md:w-[50vw]  appear opacity-0 shadow-sm border-gray-100'>
            ...
            <section className='p-8 mx-10 lg:mx-52 mt-[13jgkkghjvh] lg:mt-[20vh] bg-gray-50'>
